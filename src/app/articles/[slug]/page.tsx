        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <nav aria-label="Fil d'Ariane" className="mb-6">
            <ol className="flex items-center gap-2 text-sm text-muted flex-wrap">
              ...
              <li>
                <Link href="/articles" className="hover:text-brand transition-colors">
                  Articles
                </Link>
              </li>
              <li aria-hidden="true">/</li>
              <li>
                <Link
                  href={`/articles?cat=${article.categorySlug}`}
            ...
            <div className="flex items-center gap-4 text-sm text-muted">
              ...
              <span className="flex items-center gap-1.5">
                ...
                <time dateTime={article.dateModified}>
                  {new Date(article.dateModified).toLocaleDateString("fr-FR", {
                    year: "numeric",
                    month: "long",
                    day: "numeric",
                  })}
              ...
              <section id="faq" className="mt-12 pt-10 border-t border-gray-100">
                ...
                <dl className="space-y-5">
                  {article.faqs.map((faq, i) => (
                    <div
                      key={i}
                      className="bg-warm rounded-xl p-5 border border-gray-100"
                    >
                      <dt className="font-semibold text-ink mb-2 text-base leading-snug">
                        {faq.question}
                      </dt>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {articles
                    ...
                    .map((related) => (
                      ...
                      >
                        <span className={`text-xs font-semibold px-2 py-0.5 rounded-full ${related.categoryColor} mb-2 inline-block`}>
                          {related.category}
                        </span>
